...
async function getAuth() {
    ...
    try {
        ...
        const { getAuth: firebaseGetAuth } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
        // Initialize Auth
...
async function getFirestore() {
    ...
    try {
        const { initializeApp, getApps } = await __turbopack_context__.A("[project]/node_modules/firebase/app/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
        const { getFirestore: firebaseGetFirestore } = await __turbopack_context__.A("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
...
async function signInWithEmailAndPassword(email, password) {
    ...
    try {
        ...
        const { signInWithEmailAndPassword: firebaseSignIn } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
        // Sign in
...
async function createUserWithEmailAndPassword(email, password) {
    ...
    try {
        ...
        const { createUserWithEmailAndPassword: firebaseCreateUser } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
        // Create user
...
async function signOut() {
    ...
    try {
        ...
        const { signOut: firebaseSignOut } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
        // Sign out
...
async function onAuthStateChanged(callback) {
    ...
    try {
        ...
        const { onAuthStateChanged: firebaseOnAuthStateChanged } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
        // Set up listener
...
async function sendPasswordResetEmail(email) {
    ...
    try {
        ...
        const { sendPasswordResetEmail: firebaseSendPasswordResetEmail } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
...
async function updateUserProfile(profile) {
    ...
    try {
        ...
        const { updateProfile } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/esm/index.esm.js [app-client] (ecmascript, async loader)");
        // Update profile
...
_s(OnboardingModal, "8bdG7mPPVXUJurAs7lG/mHknluY=");
_c = OnboardingModal;
var _c;
...
function AuthProvider({ children }) {
    ...
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [authInitialized, setAuthInitialized] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const setupAuthListener = {
                "AuthProvider.useEffect.setupAuthListener": async ()=>{
                    try {
                        ...
                        await new Promise({
                            "AuthProvider.useEffect.setupAuthListener": (resolve)=>setTimeout(resolve, 1000)
                        }["AuthProvider.useEffect.setupAuthListener"]);
                        ...
                        while(!authInstance && retries < 3){
                            try {
                                authInstance = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuth"])();
                                if (!authInstance) {
                        ...
                        const unsubscribe = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])({
                            "AuthProvider.useEffect.setupAuthListener": (authUser)=>{
            ...
            }["AuthProvider.useEffect"], 10000); // 10 second timeout
            return ({
                "AuthProvider.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            async function loadProfile() {
                ...
                try {
                    const firestore = await __turbopack_context__.A("[project]/lib/firebase.ts [app-client] (ecmascript, async loader)").then({
                        "AuthProvider.useEffect.loadProfile": (m)=>m.getFirestore()
    ...
    const saveUserProfile = async (data)=>{
        ...
        try {
            const firestore = await __turbopack_context__.A("[project]/lib/firebase.ts [app-client] (ecmascript, async loader)").then((m)=>m.getFirestore());
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        children: [
            children,
            user && userProfile === null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$onboarding$2d$modal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                open: true,
                onClose: async ()=>{
                    try {
...
_s(AuthProvider, "jbC09OwwgVLyP+NILUDtHYPKMos=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_be1d5acf._.js.map