...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyD_NlRv624BdPbDGeC4fVkMylsY1VaHr2o") || "AIzaSyBmT9icPBVZFH-jKgZRJ3y-0hRXbwYwTJw",
    authDomain: ("TURBOPACK compile-time value", "unbusy-f12ff.firebaseapp.com") || "demo-project-12345.firebaseapp.com",
    projectId: ("TURBOPACK compile-time value", "unbusy-f12ff") || "demo-project-12345",
    storageBucket: ("TURBOPACK compile-time value", "unbusy-f12ff.firebasestorage.app") || "demo-project-12345.appspot.com",
    messagingSenderId: ("TURBOPACK compile-time value", "208514943206") || "123456789012",
    appId: ("TURBOPACK compile-time value", "1:208514943206:web:832fb94836e0eed8fed327") || "1:123456789012:web:a1b2c3d4e5f6a7b8c9d0e1",
    measurementId: ("TURBOPACK compile-time value", "G-VYC3ZGZJEN")
};
...
async function getFirestore() {
    ...
    try {
        const { initializeApp, getApps } = await __turbopack_context__.A("[project]/node_modules/firebase/app/dist/index.mjs [app-ssr] (ecmascript, async loader)");
        const { getFirestore: firebaseGetFirestore } = await __turbopack_context__.A("[project]/node_modules/firebase/firestore/dist/index.mjs [app-ssr] (ecmascript, async loader)");
...
async function signInWithEmailAndPassword(email, password) {
    ...
    try {
        ...
        const { signInWithEmailAndPassword: firebaseSignIn } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/index.mjs [app-ssr] (ecmascript, async loader)");
        // Sign in
...
async function createUserWithEmailAndPassword(email, password) {
    ...
    try {
        ...
        const { createUserWithEmailAndPassword: firebaseCreateUser } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/index.mjs [app-ssr] (ecmascript, async loader)");
        // Create user
...
async function signOut() {
    ...
    try {
        ...
        const { signOut: firebaseSignOut } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/index.mjs [app-ssr] (ecmascript, async loader)");
        // Sign out
...
async function changePassword(newPassword) {
    ...
    try {
        ...
        const { updatePassword } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/index.mjs [app-ssr] (ecmascript, async loader)");
        // Update password
...
async function sendPasswordResetEmail(email) {
    ...
    try {
        ...
        const { sendPasswordResetEmail: firebaseSendPasswordResetEmail } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/index.mjs [app-ssr] (ecmascript, async loader)");
...
async function updateUserProfile(profile) {
    ...
    try {
        ...
        const { updateProfile } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/index.mjs [app-ssr] (ecmascript, async loader)");
        // Update profile
...
;
const initFirebase = initializeFirebase;
}),
...
;
;
function OnboardingModal({ open, onClose, onSave }) {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Tell us a bit about yourself so we can tailor scheduling to your needs."
                        }, void 0, false, {
                            fileName: "[project]/components/onboarding-modal.tsx",
                            lineNumber: 44,
                            columnNumber: 11
...
function AuthProvider({ children }) {
    ...
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [authInitialized, setAuthInitialized] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [userProfile, setUserProfile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(undefined);
        ...
        const setupAuthListener = async ()=>{
            try {
                ...
                while(!authInstance && retries < 3){
                    try {
                        authInstance = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuth"])();
                        if (!authInstance) {
                ...
                const unsubscribe = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onAuthStateChanged"])((authUser)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        async function loadProfile() {
            ...
            try {
                const firestore = await __turbopack_context__.A("[project]/lib/firebase.ts [app-ssr] (ecmascript, async loader)").then((m)=>m.getFirestore());
                if (!firestore) {
                    setUserProfile(null);
                    return;
                }
                const { doc, getDoc } = await __turbopack_context__.A("[project]/node_modules/firebase/firestore/dist/index.mjs [app-ssr] (ecmascript, async loader)");
    ...
    const saveUserProfile = async (data)=>{
        ...
        try {
            ...
            const { doc, setDoc } = await __turbopack_context__.A("[project]/node_modules/firebase/firestore/dist/index.mjs [app-ssr] (ecmascript, async loader)");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        children: [
            children,
            user && userProfile === null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$onboarding$2d$modal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                open: true,
                onClose: async ()=>{
                    try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0817b5ce._.js.map