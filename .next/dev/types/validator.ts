...
// Validate ../../../app/api/calendar/settings/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/calendar/settings">> = Specific
  const handler = {} as typeof import("../../../app/api/calendar/settings/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../app/api/google-calendar-config/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/google-calendar-config">> = Specific
  const handler = {} as typeof import("../../../app/api/google-calendar-config/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../app/api/google-calendar/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/google-calendar">> = Specific
  const handler = {} as typeof import("../../../app/api/google-calendar/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
